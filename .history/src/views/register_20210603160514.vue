...
export default defineComponent({
  ...
  methods: {
    onRegister: function () {
      api.register
        .register({ username: this.form.username, password: this.form.password, password2: this.form.password2, first_name: this.form.first_name, last_name: this.form.last_name, e })
        .then((res: any) => {
